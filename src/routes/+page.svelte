...
>
    ...
    >
        ...
        <div class="w-3/4">
            <div
                id="post"
                class="grid border-4 bg-slate-500"
                style="grid-template-rows: 1fr 6fr; align-items: center; justify-items: center;"
            >
                <div class="left-0 text-white text-2xl p-2">Lorum ipsum</div>
                <div
                    class="right-0 text-white text-xl p-2 bg-slate-400 h-3/4 m-16 mb-7"
                >
